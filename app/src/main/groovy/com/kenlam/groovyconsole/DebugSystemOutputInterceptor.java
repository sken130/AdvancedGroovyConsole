 ...
 *  under the License.
 *
 *  Modifications copyright 2021 Ken Lam
 *
...
public class DebugSystemOutputInterceptor extends FilterOutputStream {
     ...
     * Constructor
     *
     * @param callback accepts the id of the target AdvancedGroovyConsole instance and a
     ...
     */
    public DebugSystemOutputInterceptor(final Closure callback) {
        this(callback, true);
    }
     ...
     */
    public DebugSystemOutputInterceptor(final Closure callback, boolean output) {
     ...
     *
     * @param consoleId id of the AdvancedGroovyConsole instance executing the script
     */
